...
const resources: Resource[] = [
  ...
  },
  {
    ...
    recipe: {
      ...
      steps: [
        "Preheat the oven to 190°C (170°C fan / Gas 5) and line a baking tray with baking paper.",
        ...
        "Stir in the caster sugar, dried fruit and mixed spice until evenly distributed.",
        "Pour the beaten egg and 2 tablespoons of milk into a well in the centre.",
        "Mix with a knife to bring it together into a stiff, thick dough — add more milk if too dry.",
        "Drop rough, craggy heaps of dough onto the tray using two spoons, keeping them unshaped and rustic.",
        "Bake for 12–15 minutes until golden brown.",
        "Cool for 5 minutes on the tray before transferring to a wire rack.",
      ],
      tip: "Keep them craggy — don't smooth or shape the dough.",
    },
  },
  {
    id: "land-kyc",
