...
const games = [
  {
    id: "crossword",
    title: "Botswana Crossword",
    description: "Test your knowledge of Botswana locations and family names",
    icon: Grid3X3,
  ...
  },
  {
    id: "bible-trivia",
    title: "Bible Trivia",
    description: "Challenge yourself with questions from the Holy Bible",
    icon: BookOpen,
  ...
  },
  {
    id: "family-trivia",
    title: "Family Trivia",
    description: "How well do you know your family history and members?",
    icon: Users,
  ...
  },
  {
    id: "crazy-8",
    title: "Crazy 8",
    description: "Match cards and be the first to empty your hand",
    icon: Spade,
  ...
  },
  {
    id: "rummy",
    title: "Rummy",
    description: "Form sets and runs in this classic card game",
    icon: Spade,
  ...
  {
    id: "family-puzzle",
    title: "Family Puzzles",
    description: "Solve puzzles using cherished family photos",
    icon: Puzzle,
